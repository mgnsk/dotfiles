...
return {
	{
		"neomake/neomake",
		dir = vim.fn.stdpath("data") .. "/plugins/neomake",
	...
	},
	{
		...
		dir = vim.fn.stdpath("data") .. "/plugins/vim-cspell",
		event = "VeryLazy",
		init = function()
	...
	},
	{
		...
		dir = vim.fn.stdpath("data") .. "/plugins/jsonpath.nvim",
		lazy = true,
		init = function()
	...
	{
		"stevearc/oil.nvim",
		dir = vim.fn.stdpath("data") .. "/plugins/oil.nvim",
		cmd = "Oil",
		config = function()
