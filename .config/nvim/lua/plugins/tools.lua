...
return {
	{
		"neomake/neomake",
		dir = vim.fn.stdpath("config") .. "/plugins/neomake",
	...
	},
	{
		...
		dir = vim.fn.stdpath("config") .. "/plugins/vim-cspell",
		event = "VeryLazy",
		init = function()
	...
	},
	{
		...
		dir = vim.fn.stdpath("config") .. "/plugins/jsonpath.nvim",
		lazy = true,
		init = function()
	...
	{
		"stevearc/oil.nvim",
		dir = vim.fn.stdpath("config") .. "/plugins/oil.nvim",
		cmd = "Oil",
		config = function()
