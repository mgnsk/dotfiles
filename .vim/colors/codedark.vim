...
let s:cdBack = {'gui': '#161616', 'cterm': s:cterm00, 'cterm256': '234'}

let s:cdTabCurrent = {'gui': '#161616', 'cterm': s:cterm00, 'cterm256': '234'}
...
call <sid>hi('TabLine', s:cdGray, s:cdBack, 'none', {})
call <sid>hi('TabLineFill', s:cdGray, s:cdBack, 'none', {})
call <sid>hi('TabLineSel', s:cdFront, s:cdBack, 'none', {})
