...
elseif s:configuration.style ==# 'atlantis'
  let s:palette = {
        \ 'black':      ['#181a1c',   '237',  'DarkGrey'],
        \ 'bg0':        ['#1e1e1e',   '235',  'Black'],
        \ 'bg1':        ['#212121',   '236',  'DarkGrey'],
        \ 'bg2':        ['#252525',   '236',  'DarkGrey'],
        \ 'bg3':        ['#333333',   '237',  'DarkGrey'],
        \ 'bg4':        ['#424242',   '237',  'Grey'],
        ...
        \ 'fg':         ['#abb2aa',   '250',  'White'],
        \ 'red':        ['#AA505B',   '203',  'Red'],
        \ 'orange':     ['#A29E66',   '215',  'Orange'],
        \ 'yellow':     ['#C6AA40',   '179',  'Yellow'],
...
call s:HL('TabLineSel', s:palette.bg_green, s:palette.diff_blue)
...
call s:HL('Keyword', s:palette.yellow, s:palette.none)
call s:HL('Define', s:palette.red, s:palette.none)
call s:HL('Typedef', s:palette.yellow, s:palette.none)
...
call s:HL('String', s:palette.orange, s:palette.none)
call s:HL('Character', s:palette.orange, s:palette.none)
